...
const Day: React.FC<DayProps> = ({ date, onDayClick, isSelected }) => {
  ...
  let dayClass = "w-[42px] h-[42px] flex flex-col items-center justify-center p-2.5 text-center text-lg rounded-full transition-colors duration-300 ease-in-out";
  ...
  if (isPast) {
    ...
    dayClass += " bg-[#ff465d] [background:linear-gradient(90deg,_#ff465d,_#bc46ba)] cursor-pointer";
  } else if (isSelected) {
    dayClass += " bg-[#0a6dc2] text-white cursor-pointer";
  } else {
