  ...
  return (
    <div className="flex justify-between text-white text-lg items-center mt-12  ">
      <button
        ...
        className={`flex items-center justify-center w-8 h-8 ${isCurrentMonth ? 'opacity-50' : ''}`}
      > 
        <Image src="/Vector.svg" alt="Previous Month" width="0" height="0" className="w-2 h-4" />
      </button>
      ...
      >
        <Image src="/Vector1.svg" alt="Previous Month" width="0" height="0" className="w-2 h-4" />
